...
fn j_invariant_test() {
    ...
    assert_eq_str!(j_invariant(&BigInt::from(4)), "20245856256 q^4 + 864299970 q^3 + 21493760 q^2 + 196884 q + 744 + q^-1");
    assert_eq_str!(j_invariant(&BigInt::from(5)), "333202640600 q^5 + 20245856256 q^4 + 864299970 q^3 + 21493760 q^2 + 196884 q + 744 + q^-1");
    assert_eq_str!(j_invariant(&BigInt::from(6)), "4252023300096 q^6 + 333202640600 q^5 + 20245856256 q^4 + 864299970 q^3 + 21493760 q^2 + 196884 q + 744 + q^-1");
}
